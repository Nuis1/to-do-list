<div class="bg-white shadow-sm hover:shadow-md duration-200 ease-in-out border-l-4 md:border-l-6 border-red-600 rounded-lg md:rounded-2xl p-4 md:p-5">
    <div class="flex flex-col sm:flex-row sm:justify-between gap-4">
        <div class="flex gap-3 md:gap-4 flex-1">
            <div class="w-6 h-6 md:w-8 md:h-8 border-2 border-indigo-600 rounded-full flex-shrink-0"></div>
            <div class="flex-1 min-w-0">
                <p class="font-medium text-base md:text-lg mb-1">Tugas 1</p>
                <p class="text-sm md:text-base text-gray-500 line-clamp-2">Lorem ipsum dolor sit amet consectetur adipiscing elit quisque faucibus.</p>
                <div class="flex flex-col sm:flex-row gap-3 md:gap-6 mt-3 md:mt-4">
                    <div class="flex items-center gap-2">
                        ...
                        <p class="text-sm md:text-base text-gray-500">11 Desember 2025</p>
                    </div>
                    <div class="flex items-center gap-2">
                        ...
                        <p class="text-sm md:text-base text-red-600">Terlambat 0 hari</p>
                    </div>
                </div>
            </div>
        </div>
        <div class="flex sm:flex-col justify-between sm:justify-end items-center sm:items-end gap-3">
            <div class="bg-red-100 py-1 px-3 rounded-full text-red-800 text-sm whitespace-nowrap">Terlambat</div>
...
<div class="bg-white shadow-sm hover:shadow-md duration-200 ease-in-out border-l-4 md:border-l-6 border-red-600 rounded-lg md:rounded-2xl p-4 md:p-5">
    <div class="flex flex-col sm:flex-row sm:justify-between gap-4">
        <div class="flex gap-3 md:gap-4 flex-1">
            <div class="w-6 h-6 md:w-8 md:h-8 border-2 border-indigo-600 rounded-full flex-shrink-0"></div>
            <div class="flex-1 min-w-0">
                <p class="font-medium text-base md:text-lg mb-1">Tugas 2</p>
                <p class="text-sm md:text-base text-gray-500 line-clamp-2">Lorem ipsum dolor sit amet consectetur adipiscing elit quisque faucibus.</p>
                <div class="flex flex-col sm:flex-row gap-3 md:gap-6 mt-3 md:mt-4">
                    <div class="flex items-center gap-2">
                        <svg class="w-5 h-5 md:w-6 md:h-6 flex-shrink-0" viewBox="0 0 23 23" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <p class="text-sm md:text-base text-gray-500">9 Desember 2025</p>
                    </div>
                    <div class="flex items-center gap-2">
                        <svg class="w-5 h-5 md:w-6 md:h-6 flex-shrink-0" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <circle cx="12" cy="12" r="11.5" fill="white" stroke="#FF0000" />
                        ...
                        <p class="text-sm md:text-base text-red-600">Terlambat 2 hari</p>
                    </div>
                </div>
            </div>
        </div>
...
<div class="bg-white shadow-sm hover:shadow-md duration-200 ease-in-out border-l-4 md:border-l-6 border-blue-600 rounded-lg md:rounded-2xl p-4 md:p-5">
    <div class="flex flex-col sm:flex-row sm:justify-between gap-4">
        <div class="flex gap-3 md:gap-4 flex-1">
            <div class="w-6 h-6 md:w-8 md:h-8 border-2 border-indigo-600 rounded-full flex-shrink-0"></div>
            <div class="flex-1 min-w-0">
                <p class="font-medium text-base md:text-lg mb-1">Tugas 3</p>
                <p class="text-sm md:text-base text-gray-500 line-clamp-2">Lorem ipsum dolor sit amet consectetur adipiscing elit quisque faucibus.</p>
                <div class="flex flex-col sm:flex-row gap-3 md:gap-6 mt-3 md:mt-4">
                    <div class="flex items-center gap-2">
                        <svg class="w-5 h-5 md:w-6 md:h-6 flex-shrink-0" viewBox="0 0 23 23" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <path d="M-2 6C-2 3.23858 0.238576 1 3 1H20C22.7614 1 25 3.23858 25 6H21C21 5.44772 20.5523 5 20 5H3C2.44772 5 2 5.44772 2 6H-2ZM23 10H0H23ZM-2 10V6C-2 3.23858 0.238576 1 3 1V5C2.44772 5 2 5.44772 2 6V10H-2ZM20 1C22.7614 1 25 3.23858 25 6V10H21V6C21 5.44772 20.5523 5 20 5V1Z" fill="#808080" mask="url(#path-2-inside-3)" />
                            <line x1="8" y1="1" x2="8" y2="6" stroke="#808080" stroke-width="2" stroke-linecap="round" />
                            <line x1="15" y1="1" x2="15" y2="6" stroke="#808080" stroke-width="2" stroke-linecap="round" />
                        </svg>
                        <p class="text-sm md:text-base text-gray-500">14 Desember 2025</p>
                    </div>
                    <div class="flex items-center gap-2">
                        <svg class="w-5 h-5 md:w-6 md:h-6 flex-shrink-0" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <circle cx="12" cy="12" r="11.5" fill="white" stroke="#2563eb" />
                            <path d="M12.2475 4.75251C12.1108 4.61583 11.8892 4.61583 11.7525 4.75251L9.52513 6.9799C9.38844 7.11658 9.38844 7.33819 9.52513 7.47487C9.66181 7.61156 9.88342 7.61156 10.0201 7.47487L12 5.49497L13.9799 7.47487C14.1166 7.61156 14.3382 7.61156 14.4749 7.47487C14.6116 7.33819 14.6116 7.11658 14.4749 6.9799L12.2475 4.75251ZM12 13L12.35 13L12.35 5L12 5L11.65 5L11.65 13L12 13Z" fill="#2563eb" />
                            <path d="M18.0686 17.3432C18.2582 17.3053 18.3811 17.1209 18.3432 16.9314L17.7254 13.8425C17.6875 13.653 17.5031 13.5301 17.3136 13.568C17.124 13.6059 17.0011 13.7903 17.039 13.9798L17.5882 16.7254L14.8425 17.2746C14.653 17.3125 14.5301 17.4969 14.568 17.6864C14.6059 17.876 14.7903 17.9989 14.9798 17.961L18.0686 17.3432ZM12 13L11.8059 13.2912L17.8059 17.2912L18 17L18.1941 16.7088L12.1941 12.7088L12 13Z" fill="#2563eb" />
                        </svg>
                        <p class="text-sm md:text-base text-blue-600">3 hari lagi</p>
                    </div>
                </div>
            </div>
        </div>
        <div class="flex sm:flex-col justify-between sm:justify-end items-center sm:items-end gap-3">
            <div class="bg-blue-100 py-1 px-3 rounded-full text-blue-800 text-sm whitespace-nowrap">Aktif</div>
            <div class="flex gap-2 md:gap-4">
                <button class="cursor-pointer h-9 w-9 md:h-10 md:w-10 flex justify-center items-center hover:bg-gray-200 rounded duration-200 ease-in-out">
                    <svg class="w-5 h-5 md:w-6 md:h-6" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M3 17.25V21H6.75L17.81 9.93999L14.06 6.18999L3 17.25Z" stroke="#808080" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
...
<div class="bg-white shadow-sm hover:shadow-md duration-200 ease-in-out border-l-4 md:border-l-6 border-blue-600 rounded-lg md:rounded-2xl p-4 md:p-5">
    <div class="flex flex-col sm:flex-row sm:justify-between gap-4">
        <div class="flex gap-3 md:gap-4 flex-1">
            <div class="w-6 h-6 md:w-8 md:h-8 border-2 border-indigo-600 rounded-full flex-shrink-0"></div>
            <div class="flex-1 min-w-0">
                <p class="font-medium text-base md:text-lg mb-1">Tugas 4</p>
                <p class="text-sm md:text-base text-gray-500 line-clamp-2">Lorem ipsum dolor sit amet consectetur adipiscing elit quisque faucibus.</p>
                <div class="flex flex-col sm:flex-row gap-3 md:gap-6 mt-3 md:mt-4">
                    <div class="flex items-center gap-2">
                        <svg class="w-5 h-5 md:w-6 md:h-6 flex-shrink-0" viewBox="0 0 23 23" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<div class="bg-white shadow-sm hover:shadow-md duration-200 ease-in-out border-l-4 md:border-l-6 border-green-600 rounded-lg md:rounded-2xl p-4 md:p-5">
    <div class="flex flex-col sm:flex-row sm:justify-between gap-4">
        <div class="flex gap-3 md:gap-4 flex-1">
            <svg width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                <circle cx="15" cy="15" r="15" fill="#00AF69" />
                <path d="M6 14.2856L12.6116 19.9999" stroke="white" stroke-width="2" stroke-linecap="round" />
                <path d="M24.1818 10L12.6115 19.9999" stroke="white" stroke-width="2" stroke-linecap="round" />
            </svg>
            <div class="flex-1 min-w-0">
                <p class="font-medium text-base md:text-lg mb-1 line-through">Tugas 5</p>
                <p class="text-sm md:text-base text-gray-500 line-clamp-2 line-through">Lorem ipsum dolor sit amet consectetur adipiscing elit quisque faucibus.</p>
                <div class="flex flex-col sm:flex-row gap-3 md:gap-6 mt-3 md:mt-4">
                    <div class="flex items-center gap-2">
                        <svg class="w-5 h-5 md:w-6 md:h-6 flex-shrink-0" viewBox="0 0 23 23" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M22 11V20C22 21.1046 21.1046 22 20 22H3C1.89543 22 1 21.1046 1 20V11H22Z" stroke="#808080" stroke-width="2" />
        ...
        <div class="flex sm:flex-col justify-between sm:justify-end items-center sm:items-end gap-3">
            <div class="bg-green-100 py-1 px-3 rounded-full text-green-800 text-sm whitespace-nowrap">Selesai</div>
            <div class="flex gap-2 md:gap-4">
                <button class="cursor-pointer h-9 w-9 md:h-10 md:w-10 flex justify-center items-center hover:bg-gray-200 rounded duration-200 ease-in-out">
                    <svg class="w-5 h-5 md:w-6 md:h-6" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M3 17.25V21H6.75L17.81 9.93999L14.06 6.18999L3 17.25Z" stroke="#808080" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
